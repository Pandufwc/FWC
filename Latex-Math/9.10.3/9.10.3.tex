...
\item Two circles with centres $\vec{O}$\text{ and }$\vec{O}\prime$ intersect at two points $\vec{A}\text{ and }\vec{B}$. A line $PQ$ is drawn parallel to $OO\prime$ through $A(or B)$ intersecting the circles at $P$ and $Q$. Prove that $PQ$=2  $OO\prime$ .
