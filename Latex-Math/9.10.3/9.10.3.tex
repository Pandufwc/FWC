...
\item If the perpendicular bisector of a chord ${AB}$ of a circle ${PXAQBY}$ intersects the circle at ${P}\text{ and }{Q}$, prove that arc ${PXA}\cong Arc {PYB}$.
\item A, B and C are three points on a circle. Prove that the perpendicular bisectors of ${AB}$, ${BC}\text{ and }{CA}$ are concurrent.
...
\item ${ABCD}$ is such a quadrilateral that ${A}$ is the centre of the circle passing through ${B}$, ${C}\text{ and }{D}$. Prove that $\angle CBD+ \angle CDB = \frac{1}{2} \angle BAD$
\item O is the circumcentre of the triangle ${ABC}\text{ and }{D}$ is the mid-point of the base ${BC}$. Prove that $\angle BOD = \angle A$.
...
\item If ${BM}\text{ and }{CN}$ are the perpendiculars drawn on the sides ${AC}\text{ and }{AB}$ of the triangle ${ABC}$, prove that the points ${B},{C},{M}\text{ and }{N}$ are concyclic.
...
\item The circumcentre of the triangle ${ABC}$ is 0. Prove that $\angle OBC + \angle BAC = 90\degree$.
...
\item Two circles with centres $O$\text{ and }$O$' intersect at two points $A$\text{ and }$B$. $A$ line $PQ$ is drawn parallel to $OO$' through $A(or B)$ intersecting the circles at $P$ and $Q$. Prove that $PQ$=2  $OO$' .
\item In Fig\ref{fig:3} $AOB$ is a diameter of the circle and $C$, $D$, $E$ are any three points of the semi-circle. Find the value of $\angle ACD + \angle BED$.
\begin{figure}[h!]
